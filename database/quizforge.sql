...
-- Tiempo de generación: 16-04-2026 a las 22:08:08
...
CREATE TABLE IF NOT EXISTS `users` (
  ...
  `provider` enum('local','google','microsoft') COLLATE utf8mb4_unicode_ci DEFAULT 'local',
...
INSERT INTO `users` (`id`, `name`, `email`, `password`, `provider`, `google_id`, `microsoft_id`, `profile_picture`, `plan`, `rol`, `created_at`, `updated_at`) VALUES
(2, 'alberto', 'alberto@gmail.com', '$2y$10$ZVtm7iT8NwQBNzyjkMUfyOOEw2JkIvRD6qCgTBFPsr42L8Mqwlmpm', 'local', NULL, NULL, NULL, 'pro', 'admin', '2026-02-09 22:02:17', '2026-04-16 22:06:27'),
(7, 'pep', 'pep@gmail.com', '$2y$10$9CEa6YSo3nXt9DLPpiTBne8SCHaaJD/7BrSTx3VVMZprfUXUT.Bwe', 'local', NULL, NULL, NULL, 'free', 'user', '2026-02-10 15:52:49', '2026-04-16 22:06:27');
