...
// Dades centres
const successIES = [
  { name: 'IES Lluís Simarro', description: t('success.case1'), img: 'images/centres/iessimarro.jpg' },
  { name: 'Aula Xàtiva Formación', description: t('success.case2'), img: 'images/centres/aulaxativa.png' },
  { name: 'IES Josep de Ribera', description: t('success.case3'), img: 'images/centres/iesjribera.jpg' },
  { name: 'IES Porçons (Aielo)', description: t('success.case4'), img: 'images/centres/iesporçons.jpg' }
]
