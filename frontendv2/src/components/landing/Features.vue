<template>
  <section id="features" class="py-5 reveal features-section">
    <div class="container text-center">

      <h2 class="fw-bold mb-3">{{ t('feat.title') }}</h2>
      <p class="text-muted mb-5">{{ t('feat.sub') }}</p>
      ...
      <div class="row row-cols-2 row-cols-md-3 row-cols-lg-5 g-4">
        ...
        >
          <div class="feature-card w-100">
            ...
            <p class="text-muted small">{{ t(f.desc) }}</p>
...
const features = [
  { 
    title: 'feat.f1_title', 
    desc: 'feat.f1_desc',
    img: 'images/features/openai.png'
  },
  { 
    title: 'feat.f2_title', 
    desc: 'feat.f2_desc',
    img: 'images/features/moodleaules.png'
  },
  { 
    title: 'feat.f3_title', 
    desc: 'feat.f3_desc',
    img: 'images/features/xml.png'
  },
  { 
    title: 'feat.f4_title', 
    desc: 'feat.f4_desc',
    img: 'images/features/questions.png'
  },
  { 
    title: 'feat.f5_title', 
    desc: 'feat.f5_desc',
    img: 'images/features/timesave.png'
  }
]
</script>
