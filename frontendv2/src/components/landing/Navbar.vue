<template>
  <nav class="navbar custom-navbar shadow-sm px-3 reveal">
    ...
    <div class="nav-right d-flex align-items-center gap-2">
      ...
      <a href="/signup" class="btn btn-cta btn-sm">
        {{ t('navbar.cta') }}
      </a>
      ...
      <div class="user-menu dropdown">
        ...
        <ul v-if="showUserMenu" class="dropdown-menu dropdown-menu-end">
          <li><a class="dropdown-item" href="/signin">{{ t('navbar.login') }}</a></li>
          <li><a class="dropdown-item" href="/signup">{{ t('navbar.register') }}</a></li>
        </ul>
      </div>
