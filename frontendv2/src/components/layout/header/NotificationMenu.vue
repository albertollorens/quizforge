<template>
  <div class="relative" ref="dropdownRef">
    ...
    >
      ...
      >
        <h5 class="text-lg font-semibold text-gray-800 dark:text-white/90">Notificacions</h5>
      ...
      <router-link
        to="#"
        :class="[
          'mt-3 flex justify-center rounded-lg border p-3 text-theme-sm font-medium shadow-theme-xs',
          isDisabled
            ? 'opacity-50 cursor-not-allowed pointer-events-none bg-gray-200 text-gray-400'
        ...
        @click="!isDisabled && handleViewAllClick"
      >
...
const notifications = ref([
  {
    id: 1,
    userName: 'Joan Cardona',
    userImage: '/images/user/user-02.jpg',
    action: 'ha creat un qüestionari sobre',
    project: 'Història d\'Espanya',
    type: 'Project',
    time: '5 min ago',
    status: 'online',
  },
  {
    ...
    action: 'ha millorat el seu pla a',
    project: 'Pro Docent',
    type: 'Project',
    time: '15 min ago',
    status: 'offline',
  ...
  {
    id: 3,
    userName: 'Marta Tormo',
    userImage: '/images/user/user-04.jpg',
    action: 'ha cancel·lat la seua subscripció al pla',
    project: 'Pro Docent',
    type: 'Project',
    time: '22 min ago',
    status: 'offline',
  ...
  },
  {
    ...
    action: 'ha generat un qüestionari amb IA sobre',
    project: 'Programació amb Python',
    type: 'Project',
    time: '50 min ago',
    status: 'online',
  },
