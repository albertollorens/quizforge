  ...
  >
    ...
    >
      <div class="flex justify-between">
        <div>
          <h3 class="text-lg font-semibold text-gray-800 dark:text-white/90">Objectiu mensual</h3>
          <p class="mt-1 text-gray-500 text-theme-sm dark:text-gray-400">
            Objectiu establert per a cada mes
          </p>
        </div>
        <div>
      ...
      <p class="mx-auto mt-1.5 w-full max-w-[380px] text-center text-sm text-gray-500 sm:text-base">
        Avui guanyes 3.287 €, és més que el mes passat. Segueix amb la teva bona feina!
      </p>
    </div>
